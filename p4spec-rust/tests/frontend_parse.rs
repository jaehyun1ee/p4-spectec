...
#[test]
fn parse_string_returns_el_with_an_empty_source_name() {
...
#[test]
fn parse_files_preserves_path_order_and_expands_directories_in_name_order() {
    let directory = TempDirectory::new();
...
#[test]
fn parse_files_shares_uppercase_variable_context_between_files() {
    let directory = TempDirectory::new();
...
#[test]
fn parse_file_reports_invalid_utf8_at_the_invalid_byte() {
    let directory = TempDirectory::new();
