...
#[test]
fn test_whole_spec_roundtrip_preserves_relation_rules() {
...
#[test]
fn test_repeated_value_encodes_are_deterministic() {
...
#[test]
fn test_separate_value_encode_operations_are_independent() {
    let value = ValueCodec::decode(&tuple_value()).expect("decode nested IL value");
...
#[test]
fn test_nested_value_encode_assigns_unique_identifiers() {
    let value = ValueCodec::decode(&tuple_value()).expect("decode nested IL value");
...
#[test]
fn test_natural_value_wire_preserves_ocaml_json_spelling() {
...
#[test]
fn test_natural_value_wire_rejects_negative_payloads() {
    let error =
