...
//
// A circular array of slots sits beside the hash table. Each slot carries
// the key currently occupying it and a reference bit that is set on every
// hit and cleared by the clock hand on its first pass.
//
