...
use super::{ElabError, cause, primary};
...
pub(in crate::pass::elaborate) fn expression_type_mismatch(
    ...
    cause(EXPRESSION_TYPE_MISMATCH, message, vec![primary(span)], Vec::new())
}
...
pub(in crate::pass::elaborate) fn expression_iteration_mismatch(
    ...
    cause(EXPRESSION_ITERATION_MISMATCH, message, vec![primary(span)], Vec::new())
}
...
pub(in crate::pass::elaborate) fn expression_arity_mismatch(
    ...
    cause(EXPRESSION_ARITY_MISMATCH, message, vec![primary(span)], Vec::new())
}
