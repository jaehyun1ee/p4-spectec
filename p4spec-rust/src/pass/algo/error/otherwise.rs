...
pub(crate) fn otherwise_condition_invalid(span: &Span) -> AlgoError {
    cause(
...
pub(crate) fn otherwise_function_call_invalid(span: &Span) -> AlgoError {
    cause(
...
pub(crate) fn otherwise_relation_call_invalid(span: &Span) -> AlgoError {
    cause(
