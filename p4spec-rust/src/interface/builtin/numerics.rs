...
fn value_of_bits(arena: &mut ValueArena, bits: Vec<bool>) -> Result<Value, BuiltinError> {
    ...
    let value = make::list(arena, &typ, bit_values, Span::default())?;
    Ok(value)
}
...
// dec $shr_arith(arena, int, int, int) : int
...
// dec $bitstr_to_int(arena, int, bitstr) : int
...
// dec $int_to_bitstr(arena, int, int) : bitstr
...
// dec $bits_to_int_unsigned(arena, bool*) : int
...
// dec $bits_to_int_signed(arena, bool*) : int
...
// dec $int_to_bits_unsigned(arena, int) : bool*
...
// dec $int_to_bits_signed(arena, int) : bool*
...
// dec $bitacc(arena, int, int, int) : int
...
// dec $bitacc_replace(arena, int, int, int, int) : int
